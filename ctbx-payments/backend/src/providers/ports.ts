...
export interface InvestmentProvider { listProducts(context: AuthContext): Promise<unknown>; simulate(context: AuthContext, input: unknown): Promise<unknown>; createOrder(context: AuthContext, input: unknown, key: string, requestId: string): Promise<unknown>; getOrder(context: AuthContext, id: string): Promise<unknown>; listPositions(context: AuthContext): Promise<unknown>; getReceipt(context: AuthContext, id: string, requestId: string): Promise<unknown>; }
export interface BillingProvider { listPayers(context: AuthContext): Promise<unknown>; createPayer(context: AuthContext, input: unknown, key: string): Promise<unknown>; updatePayer(context: AuthContext, id: string, input: unknown): Promise<unknown>; deletePayer(context: AuthContext, id: string): Promise<unknown>; getLimits(context: AuthContext): Promise<unknown>; listBills(context: AuthContext): Promise<unknown>; createBill(context: AuthContext, input: unknown, key: string, requestId: string): Promise<unknown>; getBill(context: AuthContext, id: string): Promise<unknown>; shareBill(context: AuthContext, id: string): Promise<unknown>; getReceipt(context: AuthContext, id: string, requestId: string): Promise<unknown>; }
export interface ConsignedProvider { listProducts(context: AuthContext): Promise<unknown>; getDocuments(context: AuthContext, id: string): Promise<unknown>; getTerms(context: AuthContext, id: string): Promise<unknown>; apply(context: AuthContext, input: unknown, key: string, requestId: string): Promise<unknown>; listApplications(context: AuthContext): Promise<unknown>; getApplication(context: AuthContext, id: string): Promise<unknown>; getReceipt(context: AuthContext, id: string, requestId: string): Promise<unknown>; }
