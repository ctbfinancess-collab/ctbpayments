...
export const ADMIN_CMS_LOGIN_FIELDS = attachStatusLabel([
  ...
  { id: 'login-6', label: 'Texto de ambiente', description: 'Selo de ambiente exibido no rodapé do login.', value: '""', statusKey: 'published', lastChangedAt: '10/01/2025', changedBy: 'ana.ramos@ctbxpayments.com', version: 'v1' },
...
export const ADMIN_CMS_TEXTS = attachStatusLabel([
  ...
  { id: 'TXT-10', key: 'login.footer.environment', screen: 'Login', section: 'Rodapé', text: '', language: 'pt-BR', statusKey: 'published', lastChangedAt: '10/01/2025', changedBy: 'ana.ramos@ctbxpayments.com' },
