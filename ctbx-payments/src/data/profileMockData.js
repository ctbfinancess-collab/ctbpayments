...
export const MOCK_PROFILE={name:'Elma Bichara',document:'***.***.***-**',email:'elma@ctbx.app',phone:'(11) 99999-0000',birthDate:'Não informado',maritalStatus:'Não informado',address:{zip:'00000-000',street:'Endereço não conectado',number:'—',complement:'',district:'—',city:'São Paulo',state:'SP'}};
