...
export const MOCK_CARD_TRANSACTIONS = [
  ...
  { id: 'DEMO-CARD-0002', title: 'Recarga', date: '8 dias atrás', occurredAt: new Date(Date.now() - 8 * 86400000).toISOString(), value: '+ R$ 300,00', status: 'Concluída', authorization: 'DEMO-0002' },
