...
import { ConfirmationButton, OutlineButton } from '../../components/ui';
import { colors, spacing, typography } from '../../theme';

export default function TransferAuthorizationScreen({ navigation, route }) {
  const transfer = route.params?.transfer; const [password, setPassword] = useState(''); const [otp, setOtp] = useState(''); const [requested, setRequested] = useState(false); if (!transfer) return null;
