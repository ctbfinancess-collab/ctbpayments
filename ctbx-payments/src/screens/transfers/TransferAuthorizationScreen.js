...
export default function TransferAuthorizationScreen({ navigation, route }) {
  ...
  const request = () => { setRequested(true); Alert.alert('Token enviado', 'Digite o código de 6 dígitos enviado para o seu dispositivo.'); };
